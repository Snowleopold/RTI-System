...
axis1=101    #Number of pixels in the first dimension
axis2=101    #Number of pixels in the second dimension
size=(nodenum*(nodenum-1))
linknum=80    #Number of links
#pts is the locations of nodes in ascending order of their number
...
weights=np.matmul(np.transpose(pictre),pictre)+alpha*np.identity(axis1*axis2)        #Calculating (w^T*w + alpha*I)^-1 * w^T
